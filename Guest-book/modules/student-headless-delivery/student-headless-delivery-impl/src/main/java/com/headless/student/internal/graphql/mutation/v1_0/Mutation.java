package com.headless.student.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField(description = "add student")
	public Student addStudent(@GraphQLName("student") Student student)
		throws Exception {

		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.addStudent(student));
	}

	@GraphQLField(description = "update student")
	public Student updateStudent(@GraphQLName("student") Student student)
		throws Exception {

		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.updateStudent(student));
	}

	@GraphQLField(description = "delete student")
	public Student deleteStudent(@GraphQLName("id") Long id) throws Exception {
		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.deleteStudent(id));
	}
	...
	public Response deleteStudentBatch(
		...
		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.deleteStudentBatch(
				callbackURL, object));
	}
