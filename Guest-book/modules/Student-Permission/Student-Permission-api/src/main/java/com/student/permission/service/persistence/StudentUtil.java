...
package com.student.permission.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws com.student.permission.exception.NoSuchStudentException {
	 ...
	 * @return the matching students
	 */
	public static List<Student> findBystudentDesignation(
		String studentDesignation) {

		return getPersistence().findBystudentDesignation(studentDesignation);
	}
	...
	public static List<Student> findBystudentDesignation(
		...
		return getPersistence().findBystudentDesignation(
			studentDesignation, start, end);
	}
	...
	public static List<Student> findBystudentDesignation(
		...
		return getPersistence().findBystudentDesignation(
			studentDesignation, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findBystudentDesignation_First(
			String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws com.student.permission.exception.NoSuchStudentException {

		return getPersistence().findBystudentDesignation_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchBystudentDesignation_First(
		String studentDesignation,
		OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchBystudentDesignation_First(
			studentDesignation, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findBystudentDesignation_Last(
			String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws com.student.permission.exception.NoSuchStudentException {

		return getPersistence().findBystudentDesignation_Last(
			studentDesignation, orderByComparator);
	}
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchBystudentDesignation_Last(
		String studentDesignation,
		OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchBystudentDesignation_Last(
			studentDesignation, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findBystudentDesignation_PrevAndNext(
			long studentId, String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws com.student.permission.exception.NoSuchStudentException {

		return getPersistence().findBystudentDesignation_PrevAndNext(
			studentId, studentDesignation, orderByComparator);
	}
	 ...
	 * @param studentDesignation the student designation
	 */
	public static void removeBystudentDesignation(String studentDesignation) {
		getPersistence().removeBystudentDesignation(studentDesignation);
	}
	 ...
	 * @return the number of matching students
	 */
	public static int countBystudentDesignation(String studentDesignation) {
		return getPersistence().countBystudentDesignation(studentDesignation);
	}
