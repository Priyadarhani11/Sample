...
/**
 * The table class for the &quot;DEMO_Student&quot; database table.
 *
...
public class StudentTable extends BaseTable<StudentTable> {
	...
	public final Column<StudentTable, String> studentMobileNumber =
		createColumn(
			"studentMobileNumber", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	public final Column<StudentTable, String> studentDesignation = createColumn(
		"studentDesignation", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<StudentTable, String> studentphoto = createColumn(
		"studentphoto", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	...
	private StudentTable() {
		super("DEMO_Student", StudentTable::new);
	}
