...
package com.student.permission.service.persistence.impl;
...
import com.student.permission.model.StudentTable;
import com.student.permission.model.impl.StudentImpl;
import com.student.permission.model.impl.StudentModelImpl;
import com.student.permission.service.persistence.StudentPersistence;
import com.student.permission.service.persistence.StudentUtil;
import com.student.permission.service.persistence.impl.constants.DEMOPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBystudentDesignation;
	private FinderPath _finderPathWithoutPaginationFindBystudentDesignation;
	private FinderPath _finderPathCountBystudentDesignation;

	/**
	 * Returns all the students where studentDesignation = &#63;.
	 *
	 * @param studentDesignation the student designation
	 * @return the matching students
	 */
	@Override
	public List<Student> findBystudentDesignation(String studentDesignation) {
		return findBystudentDesignation(
			studentDesignation, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the students where studentDesignation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Student> findBystudentDesignation(
		String studentDesignation, int start, int end) {

		return findBystudentDesignation(studentDesignation, start, end, null);
	}

	/**
	 * Returns an ordered range of all the students where studentDesignation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	...
	public List<Student> findBystudentDesignation(
		...
		return findBystudentDesignation(
			studentDesignation, start, end, orderByComparator, true);
	}
	...
	public List<Student> findBystudentDesignation(
		...
		studentDesignation = Objects.toString(studentDesignation, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindBystudentDesignation;
				finderArgs = new Object[] {studentDesignation};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBystudentDesignation;
			finderArgs = new Object[] {
				studentDesignation, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Student student : list) {
					if (!studentDesignation.equals(
							student.getStudentDesignation())) {
		...
		if (list == null) {
			...
			boolean bindStudentDesignation = false;

			if (studentDesignation.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_STUDENTDESIGNATION_STUDENTDESIGNATION_3);
			}
			else {
				bindStudentDesignation = true;

				sb.append(
					_FINDER_COLUMN_STUDENTDESIGNATION_STUDENTDESIGNATION_2);
			}
			...
			try {
				...
				if (bindStudentDesignation) {
					queryPos.add(studentDesignation);
				}
	...
	/**
	 * Returns the first student in the ordered set where studentDesignation = &#63;.
	 *
	 * @param studentDesignation the student designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching student
	 ...
	 */
	@Override
	public Student findBystudentDesignation_First(
			String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchBystudentDesignation_First(
			studentDesignation, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchBystudentDesignation_First(
		String studentDesignation,
		OrderByComparator<Student> orderByComparator) {

		List<Student> list = findBystudentDesignation(
			studentDesignation, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last student in the ordered set where studentDesignation = &#63;.
	 *
	 * @param studentDesignation the student designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching student
	 ...
	 */
	@Override
	public Student findBystudentDesignation_Last(
			String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchBystudentDesignation_Last(
			studentDesignation, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchBystudentDesignation_Last(
		String studentDesignation,
		OrderByComparator<Student> orderByComparator) {

		int count = countBystudentDesignation(studentDesignation);
		...
		List<Student> list = findBystudentDesignation(
			studentDesignation, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the students before and after the current student in the ordered set where studentDesignation = &#63;.
	 *
	 * @param studentId the primary key of the current student
	 * @param studentDesignation the student designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Student[] findBystudentDesignation_PrevAndNext(
			long studentId, String studentDesignation,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		...
		try {
			...
			array[0] = getBystudentDesignation_PrevAndNext(
				session, student, studentDesignation, orderByComparator, true);

			array[1] = student;

			array[2] = getBystudentDesignation_PrevAndNext(
				session, student, studentDesignation, orderByComparator, false);
	...
	protected Student getBystudentDesignation_PrevAndNext(
		Session session, Student student, String studentDesignation,
		OrderByComparator<Student> orderByComparator, boolean previous) {
		...
		if (studentDesignation.isEmpty()) {
			sb.append(_FINDER_COLUMN_STUDENTDESIGNATION_STUDENTDESIGNATION_3);
		}
		else {
			bindStudentDesignation = true;

			sb.append(_FINDER_COLUMN_STUDENTDESIGNATION_STUDENTDESIGNATION_2);
		}
	...
	/**
	 * Removes all the students where studentDesignation = &#63; from the database.
	 *
	 * @param studentDesignation the student designation
	 */
	@Override
	public void removeBystudentDesignation(String studentDesignation) {
		for (Student student :
				findBystudentDesignation(
					studentDesignation, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of students where studentDesignation = &#63;.
	 *
	 * @param studentDesignation the student designation
	 * @return the number of matching students
	 */
	@Override
	public int countBystudentDesignation(String studentDesignation) {
		studentDesignation = Objects.toString(studentDesignation, "");

		FinderPath finderPath = _finderPathCountBystudentDesignation;

		Object[] finderArgs = new Object[] {studentDesignation};
	...
	private static final String
		_FINDER_COLUMN_STUDENTDESIGNATION_STUDENTDESIGNATION_3 =
			"(student.studentDesignation IS NULL OR student.studentDesignation = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBystudentDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBystudentDesignation",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"studentDesignation"}, true);

		_finderPathWithoutPaginationFindBystudentDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findBystudentDesignation", new String[] {String.class.getName()},
			new String[] {"studentDesignation"}, true);

		_finderPathCountBystudentDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countBystudentDesignation", new String[] {String.class.getName()},
			new String[] {"studentDesignation"}, false);
