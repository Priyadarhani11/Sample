...
package student.headless.builder.service.persistence;
...
public class studentUtil {
	...
	public static student remove(long id)
		throws student.headless.builder.exception.NoSuchstudentException {
