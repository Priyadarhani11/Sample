 ...
 * @generated
 */
@OSGiBeanProperties(property = {"model.class.name=com.hello.model.Employee"})
@ProviderType
@Transactional(
...
public interface EmployeeLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(int employeeId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(int employeeId) throws PortalException;
