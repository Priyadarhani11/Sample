...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public com.hello.model.Foo addFoo(com.hello.model.Foo foo) {
	 ...
	 */
	@Override
	public com.hello.model.Foo createFoo(int employeeId) {
		return _fooLocalService.createFoo(employeeId);
	}
	 ...
	 */
	@Override
	public com.hello.model.Foo deleteFoo(com.hello.model.Foo foo) {
	 ...
	 */
	@Override
	public com.hello.model.Foo deleteFoo(int employeeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _fooLocalService.deleteFoo(employeeId);
	}
	...
	@Override
	public com.hello.model.Foo fetchFoo(int employeeId) {
		return _fooLocalService.fetchFoo(employeeId);
	}
	 ...
	 */
	@Override
	public com.hello.model.Foo getFoo(int employeeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _fooLocalService.getFoo(employeeId);
	}
	 ...
	 */
	@Override
	public java.util.List<com.hello.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public com.hello.model.Foo updateFoo(com.hello.model.Foo foo) {
