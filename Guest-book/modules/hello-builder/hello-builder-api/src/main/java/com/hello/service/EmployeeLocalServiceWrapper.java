...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.hello.model.Employee addEmployee(
		com.hello.model.Employee employee) {
	 ...
	 */
	@Override
	public com.hello.model.Employee createEmployee(int employeeId) {
	 ...
	 */
	@Override
	public com.hello.model.Employee deleteEmployee(
		com.hello.model.Employee employee) {
	 ...
	 */
	@Override
	public com.hello.model.Employee deleteEmployee(int employeeId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.hello.model.Employee fetchEmployee(int employeeId) {
	 ...
	 */
	@Override
	public com.hello.model.Employee getEmployee(int employeeId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.hello.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public com.hello.model.Employee updateEmployee(
		com.hello.model.Employee employee) {
