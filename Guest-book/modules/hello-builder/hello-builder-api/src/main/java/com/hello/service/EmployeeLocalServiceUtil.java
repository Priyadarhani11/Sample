 ...
 * <code>com.hello.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.hello.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Employee fetchEmployee(int employeeId) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(int employeeId) throws PortalException {
	...
	public static void setService(EmployeeLocalService service) {
		_service = service;
	}
