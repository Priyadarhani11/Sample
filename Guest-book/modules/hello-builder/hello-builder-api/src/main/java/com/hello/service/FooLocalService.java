 ...
 * @generated
 */
@OSGiBeanProperties(property = {"model.class.name=com.hello.model.Foo"})
@ProviderType
@Transactional(
...
public interface FooLocalService
	...
	public Foo createFoo(int employeeId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Foo deleteFoo(int employeeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Foo fetchFoo(int employeeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Foo getFoo(int employeeId) throws PortalException;
