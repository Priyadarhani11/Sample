...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.hello.exception.NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee remove(int employeeId)
		throws com.hello.exception.NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee findByPrimaryKey(int employeeId)
		throws com.hello.exception.NoSuchEmployeeException {
	 ...
	 */
	public static Employee fetchByPrimaryKey(int employeeId) {
