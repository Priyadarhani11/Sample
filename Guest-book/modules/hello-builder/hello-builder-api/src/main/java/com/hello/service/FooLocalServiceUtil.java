 ...
 * <code>com.hello.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.hello.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new foo
	 */
	public static Foo createFoo(int employeeId) {
		return getService().createFoo(employeeId);
	}
	 ...
	 */
	public static Foo deleteFoo(int employeeId) throws PortalException {
		return getService().deleteFoo(employeeId);
	}
	...
	public static Foo fetchFoo(int employeeId) {
		return getService().fetchFoo(employeeId);
	}
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static Foo getFoo(int employeeId) throws PortalException {
		return getService().getFoo(employeeId);
	}
