...
import com.demo.bank.model.BankTable;
import com.demo.bank.model.impl.BankImpl;
import com.demo.bank.model.impl.BankModelImpl;
...
@Component(
	property = {
		"class.name=com.demo.bank.model.impl.BankImpl", "table.name=BANK_Bank"
	},
