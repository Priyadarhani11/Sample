 ...
 * @generated
 */
public abstract class BankFinderBaseImpl extends BasePersistenceImpl<Bank> {

	public BankFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return bankPersistence.getBadColumnNames();
	}
