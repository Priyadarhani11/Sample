...
<%@page import="com.guestbook.service.GuestbookLocalService"%>
...
<aui:nav cssClass="nav-tabs">
     ...
     <%
        List<Guestbook> guestbooks = GuestbookLocalServiceUtil.getGuestbooks(-1, -1);
...
<liferay-ui:search-container-column-text property="message" />
 ...
 <liferay-ui:search-container-column-text property="mobile" />
