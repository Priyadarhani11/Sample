...
import com.seconddb.model.StudentModel;
...
/**
 * The base model implementation for the Student service. Represents a row in the &quot;students&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table students (uuid_ VARCHAR(75) null,studentId INTEGER not null primary key,studentName VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table students";
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"studentId",
				(BiConsumer<Student, Integer>)Student::setStudentId);
			attributeSetterBiConsumers.put(
				"studentName",
