...
package com.seconddb.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws com.seconddb.exception.NoSuchStudentException {
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student remove(int studentId)
		throws com.seconddb.exception.NoSuchStudentException {
	 ...
	 */
	public static Student fetchByPrimaryKey(int studentId) {
