...
public interface StudentLocalService
	...
	public Student deleteStudent(int studentId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student getStudent(int studentId) throws PortalException;
