 ...
 * @generated
 */
@ImplementationClassName("Web.Services.builder.model.impl.StudentImpl")
@ProviderType
public interface Student extends PersistedModel, StudentModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>Web.Services.builder.model.impl.StudentImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
