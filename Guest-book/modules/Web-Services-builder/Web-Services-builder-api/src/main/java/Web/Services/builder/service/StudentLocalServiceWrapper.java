...
public class StudentLocalServiceWrapper
	...
	@Override
	public Web.Services.builder.model.Student addStudent(
		Web.Services.builder.model.Student student) {
	 ...
	 */
	@Override
	public Web.Services.builder.model.Student createStudent(long studentId) {
	 ...
	 */
	@Override
	public Web.Services.builder.model.Student deleteStudent(
		Web.Services.builder.model.Student student) {
	...
	@Override
	public Web.Services.builder.model.Student fetchStudent(long studentId) {
	 ...
	 */
	@Override
	public Web.Services.builder.model.Student fetchStudentByUuidAndGroupId(
	 ...
	 */
	@Override
	public Web.Services.builder.model.Student getStudentByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<Web.Services.builder.model.Student> getStudents(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<Web.Services.builder.model.Student>
	...
	public java.util.List<Web.Services.builder.model.Student>
		getStudentsByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<Web.Services.builder.model.Student> orderByComparator) {
