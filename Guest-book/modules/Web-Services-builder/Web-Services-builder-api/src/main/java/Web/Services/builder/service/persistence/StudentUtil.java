...
package Web.Services.builder.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws Web.Services.builder.exception.NoSuchStudentException {
